  ...
  return (
    <div>
      ...
      <header className="pt-6 pb-2">
        <h1 className="font-display text-4xl sm:text-6xl uppercase leading-[0.95] tracking-tight text-gray-900 dark:text-[#f4ede2]">
          Who&apos;s got the <span className="text-orange-500">best</span> wings?
        </h1>
        <p className="mt-3 text-lg text-gray-600 dark:text-[#9a8d82] max-w-xl">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <Link
          href="/spots/new"
          className="border border-gray-300 dark:border-[#2c2521] text-gray-800 dark:text-[#f4ede2] px-6 py-3 rounded-xl font-display text-sm uppercase tracking-[0.12em] hover:border-orange-500 hover:text-orange-500 transition-colors"
        >
          Add a spot
        </Link>
      </div>
